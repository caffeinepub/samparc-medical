        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden md:flex items-center gap-1">
              ...
              <Link
                to="/admin"
                className="ml-2 px-4 py-2 rounded-md text-sm font-semibold bg-gold text-white hover:bg-gold-dark transition-all duration-200 shadow-sm"
              >
                Admin
              </Link>
            </nav>
          ...
          <div className="md:hidden bg-white border-t border-gray-100 shadow-lg animate-slide-down">
            <div className="px-4 py-3 space-y-1">
              ...
              <Link
                to="/admin"
                onClick={() => setMobileOpen(false)}
                className="block px-4 py-3 rounded-md text-sm font-semibold bg-gold text-white hover:bg-gold-dark transition-all"
              >
                Admin Dashboard
              </Link>
            </div>
